    ...
    <div className="min-h-screen bg-background">
      ...
      {isNavOpen && (
        <div className="fixed inset-0 bg-white z-40 pt-16 md:hidden">
          <div className="flex flex-col space-y-4 p-4">
            ...
            <a href="#contact" className="text-gray-700 hover:text-primary transition-colors">Contact</a>
            <Button 
              className="bg-[#22C55E] text-white hover:bg-[#22C55E]/90 w-full"
              onClick={() => window.open("https://wa.me/+911234567890", "_blank")}
            >
              Book Appointment
            </Button>
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          <span className="inline-block bg-[#F2FCE2] text-[#22C55E] px-4 py-1 rounded-full text-sm font-medium mb-4 animate-fade-in">
          ...
          <div className="h-[120px] md:h-[144px] mb-6">
            <AnimatePresence mode="wait">
              ...
              >
                ...
                <span className="text-[#0FA0CE]">{headlines[currentHeadlineIndex].highlight}</span>
              </motion.h1>
            </AnimatePresence>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-up">
            <Button 
              className="bg-[#22C55E] text-white hover:bg-[#22C55E]/90 px-8 py-6 text-lg w-full sm:w-auto"
              onClick={() => window.open("https://wa.me/+911234567890", "_blank")}
            >
              Book Appointment on WhatsApp
            </Button>
            <Button 
              className="bg-[#0FA0CE] text-white hover:bg-[#0FA0CE]/90 px-8 py-6 text-lg w-full sm:w-auto"
      ...
      <section id="services" className="py-16 bg-[#F6F6F7]">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <span className="inline-block bg-[#D3E4FD] text-[#0FA0CE] px-4 py-1 rounded-full text-sm font-medium mb-4">
              Our Services
            </span>
