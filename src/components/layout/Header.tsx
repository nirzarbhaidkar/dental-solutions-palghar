    ...
    <>
      ...
      <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${isScrolled ? 'liquid-glass-scrolled' : 'liquid-glass'}`}>
        <div className="px-4 sm:px-6 lg:px-8">
          <div className="relative flex items-center justify-center h-16 md:h-16 lg:justify-between">
            {/* Logo */}
            <Link 
              to="/" 
              className="text-lg sm:text-lg md:text-lg lg:text-xl font-bold text-primary flex-shrink-0"
            >
